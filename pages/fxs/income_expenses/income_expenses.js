Page({
   ...
   */
  data: {
    itemBg: "/assets/imgs/fxs_income_expenses_fxsyj.png",
    listData: [],
  ...
  v_item_itemOnClick: function(e) {
    ...
    wx.navigateTo({
      url: "../income_expenses_detail/income_expenses_detail?date=" + jsonDate,
    })
  },
 ...
 /**
  ...
  getInfo: function (onPullDownRefresh) {
    ...
    console.log(this.data.mPage);
    var reqTask = wx.request({
      url: wx.db.url('asset/getIncomeList'),
      data: {
